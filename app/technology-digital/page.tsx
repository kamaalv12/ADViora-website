...
const service = SERVICES_DATA['technology-digital'];

export const metadata: Metadata = {
  title: 'Technology & Digital Transformation — ADViora Consulting',
  ...
  return (
    <>
      ...
      <section className="section service-descriptions detail-page-body">
        <div className="wrap">
          <article className="service-detail" id="technology-description">
            <div>
