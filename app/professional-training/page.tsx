...
const service = SERVICES_DATA['professional-training'];

export const metadata: Metadata = {
  title: 'Professional Training & Development — ADViora Consulting',
  ...
  return (
    <>
      ...
      <section className="section service-descriptions detail-page-body">
        <div className="wrap">
          <article className="service-detail" id="training-description">
            <div>
